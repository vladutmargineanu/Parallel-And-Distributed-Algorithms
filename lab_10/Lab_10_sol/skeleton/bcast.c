...
/* Transmite o valoare catre toate procesele in timp logaritmic. Din momentul in
 care un proces isi primeste numarul, acesta va incepe sa il transmita mai departe 
 altor procese.

La fiecare pas, i, un proces cu rangul r care a primit deja numarul, il va trimite
catre procesul r + (1 << i)*/