...
pozitiilor unei anumite parti din vector
(interval calculat ca la threaduri). Pozitiile sunt salvate in vectorul pos.

La final, toate procesele ii trimit primului vectorul lor pos, iar acesta pune 
intr-un vector auxiliar (pentru simplitate) valorile din vel initial conform 
pozitiilor primite. */