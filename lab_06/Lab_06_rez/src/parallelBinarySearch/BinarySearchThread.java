...
public class BinarySearchThread extends Thread {
 ...
 /*
  * Cautare binara paralelizata: fiecare thread cauta intr-un subinterval
  * din cel de interes. La fiecare pas, intervalul de interes, devine
  * intervalul threadului intre capetele caruia se afla elementul cautat.
  */